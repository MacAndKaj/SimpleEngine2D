...
#
# By default, the dynamic libraries of SFML will be found. To find the src ones instead,
# you must set the SFML_STATIC_LIBRARIES variable to TRUE before calling find_package(SFML ...).
# Since you have to link yourself all the SFML dependencies when you link it statically, the following
# additional variables are defined: SFML_XXX_DEPENDENCIES and SFML_DEPENDENCIES (see their detailed
# description below).
# In case of src linking, the SFML_STATIC macro will also be defined by this script.
# example:
...
#   - SFML_XXX_DEPENDENCIES:    the list of libraries the module depends on, in case of src linking
# - SFML_LIBRARIES:    the list of all libraries corresponding to the required modules
# - SFML_FOUND:        true if all the required modules are found
# - SFML_INCLUDE_DIR:  the path where SFML headers are located (the directory containing the SFML/Config.hpp file)
# - SFML_DEPENDENCIES: the list of libraries SFML depends on, in case of src linking
#
# example:
...
# define the SFML_STATIC macro if src build was chosen
...
foreach(FIND_SFML_COMPONENT ${SFML_FIND_COMPONENTS})
    ...
    # no suffix for sfml-main, it is always a src library
...
# in case of src linking, we must also define the list of all the dependencies of SFML libraries
if(SFML_STATIC_LIBRARIES)
